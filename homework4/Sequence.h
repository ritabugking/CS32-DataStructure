...
template <typename ItemType>
typename Sequence<ItemType>::Node* Sequence<ItemType>::doErase(Node* p)  // add typename
{
...
template <typename ItemType>
typename Sequence<ItemType>::Node* Sequence<ItemType>::nodeAtPos(int pos) const // add typename
{
    Node* p;
